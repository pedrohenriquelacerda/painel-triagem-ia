        ...
        <div className="flex min-w-0 items-center gap-3 sm:gap-4">
          ...
          <div className="min-w-0 leading-tight">
            <div className="flex items-center gap-2">
              <span className="truncate text-sm font-bold tracking-tight">Triagem IA · Radiologia</span>
            ...
            <div className="mt-0.5 truncate text-[11px] font-medium uppercase tracking-[0.16em] text-white/55">Emergência · TC e RM de Crânio</div>
          </div>
        </div>
