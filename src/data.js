...
window.SEED_PATIENTS = [
  ...
  {
    id: "EXM-48155", name: "Osvaldo Nunes Tavares", age: 68, sex: "M", mrn: "PRT-512604",
    protocol: "Crânio s/ contraste", equipment: "Siemens Somatom — AMB-01", series: 3, slices: 30,
    finding: "Sem achados agudos", findingDesc: "Controle — sem achados agudos", findingType: "neg",
    probability: 0.04, priority: "rotina", priorityRank: 9, wait: 11500, setor: "ambulatorio", status: "pendente",
    roi: null, sliceFocus: 16, measure: { label: "Linha média", value: "Centrada" },
    aiNotes: "Exame de controle ambulatorial sem evidência de achados agudos. Espera prolongada (~8 dias) elevou a prioridade próxima ao limite do setor.",
  },
  {
    id: "EXM-48142", name: "Terezinha de Jesus Moraes", age: 59, sex: "F", mrn: "PRT-487330",
    protocol: "Crânio c/ contraste", equipment: "Philips Ingenia MR — AMB-02", series: 4, slices: 36,
    finding: "Lesão expansiva (provável meningioma)", findingDesc: "Lesão extra-axial — meningioma?", findingType: "alto",
    probability: 0.71, priority: "alto", priorityRank: 7, wait: 7200, setor: "ambulatorio", status: "pendente",
    roi: { top: 26, left: 52, w: 18, h: 18, label: "Lesão extra-axial · frontal D" },
    sliceFocus: 19, measure: { label: "Maior diâmetro", value: "22 mm" },
    aiNotes: "Lesão extra-axial com realce homogêneo e base dural na convexidade frontal direita (~22 mm), compatível com meningioma. Investigação eletiva; sem efeito de massa significativo.",
  },
  {
    id: "EXM-48168", name: "Lourdes Fátima Camargo", age: 64, sex: "F", mrn: "PRT-559017",
    protocol: "Crânio s/ contraste", equipment: "Siemens Somatom — AMB-01", series: 3, slices: 29,
    finding: "Alterações crônicas", findingDesc: "Microangiopatia / gliose crônica", findingType: "neg",
    probability: 0.11, priority: "rotina", priorityRank: 9, wait: 2880, setor: "ambulatorio", status: "pendente",
    roi: null, sliceFocus: 15, measure: { label: "Linha média", value: "Centrada" },
    aiNotes: "Hipodensidades periventriculares compatíveis com microangiopatia crônica de pequenos vasos. Sem achados agudos. Acompanhamento ambulatorial.",
  },
  {
