...
window.SEED_PATIENTS = [
  {
    ...
    probability: 0.97, priority: "critico", priorityRank: 3, wait: 9, status: "pendente",
  ...
  },
  {
    ...
    probability: 0.95, priority: "critico", priorityRank: 1, wait: 14, status: "pendente",
  ...
  },
  {
    ...
    probability: 0.93, priority: "critico", priorityRank: 4, wait: 19, status: "pendente",
  ...
  },
  {
    ...
    probability: 0.91, priority: "critico", priorityRank: 5, wait: 26, status: "em_laudo",
  ...
  },
  {
    ...
    probability: 0.87, priority: "critico", priorityRank: 3, wait: 33, status: "pendente",
  ...
  },
  {
    ...
    probability: 0.56, priority: "alto", priorityRank: 6, wait: 41, status: "pendente",
  ...
  },
  {
    ...
    probability: 0.03, priority: "rotina", priorityRank: 9, wait: 52, status: "pendente",
  ...
  },
  {
    ...
    protocol: "Crânio s/ contraste", equipment: "Canon Aquilion — EMERG-03", series: 3, slices: 29,
    finding: "Sem achados agudos", findingDesc: "Sem achados agudos", findingType: "neg",
    probability: 0.05, priority: "rotina", priorityRank: 9, wait: 74, status: "laudado",
...
window.INCOMING_CASE = {
  ...
  probability: 0.985, priority: "critico", priorityRank: 1, wait: 1, status: "pendente",
